...
Defines the lean 6-phase solon-spec workflow, replacing the legacy 7-phase process. Removes graphiti/ledger dependencies and introduces solon-mem for decision staging and Clio dispatch.
